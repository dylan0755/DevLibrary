...
public class MediaMuxerWrapper {
     ...
     *
     * @param encoder instance of MediaVideoEncoder or MediaStandardAudioEncoder
     */
    /*package*/ void addEncoder(final MediaEncoder encoder) {
        ...
        } else if (encoder instanceof MediaStandardAudioEncoder ||encoder instanceof MediaShareAudioEncoder) {
            if (mAudioEncoder != null)
                throw new IllegalArgumentException("Video encoder already added.");
