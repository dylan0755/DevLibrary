...
public class MediaStandardAudioEncoder extends MediaEncoder {
    private static final String TAG = MediaStandardAudioEncoder.class.getSimpleName();
    ...
    public MediaStandardAudioEncoder(final MediaMuxerWrapper muxer, final MediaEncoderListener listener) {
