...
public class LandScapeScaleUpPhotoView extends LandScapePhotoView {
    ...
    private LandScapeScaleUpPhotoView.OnPrepareMatrixListener onPrepareMatrixListener;

    public LandScapeScaleUpPhotoView(Context context) {
        this(context, (AttributeSet)null);
    }

    public LandScapeScaleUpPhotoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.TAG = LandScapeScaleUpPhotoView.class.getSimpleName();
    ...
    protected void startEnterAnimation(Bitmap bitmap, ViewLocation viewLocation) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                LandScapeScaleUpPhotoView.this.setScaling(true);
                ...
                Matrix matrix = new Matrix(LandScapeScaleUpPhotoView.this.mMatrix);
                ...
                LandScapeScaleUpPhotoView.this.setImageMatrix(matrix);
                float progress = scaleX / endValue.getScaleX();
                if (LandScapeScaleUpPhotoView.this.mAnimtorListener != null) {
                    LandScapeScaleUpPhotoView.this.mAnimtorListener.onEnterAnimProgress((int)(progress * 100.0F));
                }
        ...
        animator.addListener(new AnimatorEndListener() {
            public void onAnimationStart(Animator animation) {
                if (LandScapeScaleUpPhotoView.this.mAnimtorListener != null) {
                    LandScapeScaleUpPhotoView.this.mAnimtorListener.onEnterAnimStart();
                }

            }

            public void onAnimationEnd(Animator animation) {
                LandScapeScaleUpPhotoView.this.setScaling(false);
                LandScapeScaleUpPhotoView.this.mMatrix = new Matrix(LandScapeScaleUpPhotoView.this.getImageMatrix());
                LandScapeScaleUpPhotoView.this.mSavedMatrix.set(LandScapeScaleUpPhotoView.this.mMatrix);
                if (LandScapeScaleUpPhotoView.this.mAnimtorListener != null) {
                    LandScapeScaleUpPhotoView.this.mAnimtorListener.onEnterAnimEnd();
                }
    ...
    public boolean startExitAnim(ViewLocation vLocation, final AnimatorEndListener listener) {
        if (!checkViewLocationVaid(vLocation)) {
            ...
            if (pointFS == null) {
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    public void onAnimationUpdate(ValueAnimator animation) {
                        if (LandScapeScaleUpPhotoView.this.mMatrix != null && LandScapeScaleUpPhotoView.this.getBitmap() != null) {
                            LandScapeScaleUpPhotoView.this.setScaling(true);
                            ...
                            PointF[] pointFS1 = MatrixUtils.getLocation(LandScapeScaleUpPhotoView.this.mMatrix, LandScapeScaleUpPhotoView.this.getBitmap());
                            ...
                            LandScapeScaleUpPhotoView.this.mMatrix.postScale(sw, sh, currentX, currentY);
                            float dx = newX - currentX;
                            float dy = newY - currentY;
                            LandScapeScaleUpPhotoView.this.mMatrix.postTranslate(dx, dy);
                            LandScapeScaleUpPhotoView.this.mSavedMatrix.set(LandScapeScaleUpPhotoView.this.mMatrix);
                            LandScapeScaleUpPhotoView.this.setImageMatrix(LandScapeScaleUpPhotoView.this.mMatrix);
                            float progress = fromWidth / newWidth / scaleRatio;
                            if (LandScapeScaleUpPhotoView.this.mAnimtorListener != null) {
                                LandScapeScaleUpPhotoView.this.mAnimtorListener.onExitAnimProgress((int)(progress * 100.0F));
                            }
                ...
                animator.addListener(new AnimatorEndListener() {
                    public void onAnimationStart(Animator animation) {
                        if (LandScapeScaleUpPhotoView.this.mAnimtorListener != null) {
                            LandScapeScaleUpPhotoView.this.mAnimtorListener.onExitAnimStart();
                        }
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        LandScapeScaleUpPhotoView.this.mSavedMatrix.set(LandScapeScaleUpPhotoView.this.mMatrix);
                        if (LandScapeScaleUpPhotoView.this.mAnimtorListener != null) {
                            LandScapeScaleUpPhotoView.this.mAnimtorListener.onExitAnimEnd();
                        }
    ...
    public void setOnPrepareMatrixListener(LandScapeScaleUpPhotoView.OnPrepareMatrixListener listener) {
        this.onPrepareMatrixListener = listener;
    }

    public interface OnPrepareMatrixListener {
        void prepareMatrix(LandScapeScaleUpPhotoView var1, Bitmap var2);
    }
}
