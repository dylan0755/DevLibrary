...
public class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof RefreshHeaderContainerViewHolder) {
            return ;
        } else if (holder instanceof HeaderContainerViewHolder) {
            return;
        } else if (holder instanceof  FooterContainerViewHolder) {
            return ;
        } else if (holder instanceof LoadMoreFooterContainerViewHolder) {
            return ;
        } else {
