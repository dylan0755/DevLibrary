 ...
 * Desc:
 */
public class SupportFlowLayout extends ViewGroup {
    private int lineSpacing;
    private int itemSpacing;
    private boolean singleLine;

    public SupportFlowLayout(Context context) {
        this(context, (AttributeSet)null);
    }

    public SupportFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SupportFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.singleLine = false;
    }

    @TargetApi(21)
    public SupportFlowLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
