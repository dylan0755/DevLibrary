...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = Color.parseColor("#31C85A");
    private final int DEFAULT_COLOR_PRIMARY_DARK = Color.parseColor("#31C85A");;
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DLSwitchView);
        colorPrimary = a.getColor(R.styleable.DLSwitchView_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(R.styleable.DLSwitchView_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        hasShadow = a.getBoolean(R.styleable.DLSwitchView_hasShadow, true);
        isOpened = a.getBoolean(R.styleable.DLSwitchView_isOpened, false);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isCanVisibleDrawing) {
            ...
            // TODO 去掉点击时候圆圈变瘪
            bOffset = bRadius * 0f; // offset of switching
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (state == STATE_SWITCH_OFF) {
                        ...
                        toggleSwitch(true);
                        if (changedListener!=null)changedListener.toggleToOn(this);
                    } else if (state == STATE_SWITCH_ON) {
                        refreshState(STATE_SWITCH_ON2);
                        toggleSwitch(false);
                        if (changedListener!=null)changedListener.toggleToOff(this);
                    }
