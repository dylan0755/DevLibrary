...
public class IRecyclerView extends RecyclerView {
    ...
    public IRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DLIRecyclerView, defStyle, 0);
        ...
        try {
            refreshEnabled = a.getBoolean(R.styleable.DLIRecyclerView_refreshEnabled, false);
    ...
    public void setLoadMoreFooterView(@LayoutRes int loadMoreFooterLayoutRes) {
        ...
        if (loadMoreFooter != null) {
            setLoadMoreFooterView((LoadMoreFooterView) loadMoreFooter);
        }
    }
    ...
    private EndAnimatorCallBack mAnimationListener = new EndAnimatorCallBack() {
        @Override
