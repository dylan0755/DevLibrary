...
import com.dylan.library.utils.RecyclerViewUtils;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (convertView instanceof RecyclerView) {
                    if (y - mLastY > 0) {
                        if (RecyclerViewUtils.isRecyclerViewToTop(recyclerView)) {
                    ...
                    if (y - mLastY < 0) {
                        if (RecyclerViewUtils.isRecyclerViewToBottom(recyclerView)) {
