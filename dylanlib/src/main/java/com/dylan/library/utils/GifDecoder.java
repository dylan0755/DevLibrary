...
//    GifDecoder.GifFrame[] gifFrames = null;
//                try {
//        //LogUtils.e("loadGifSource","start");
//        GifDecoder gifDecoder = new GifDecoder();
//        long timeStart = System.currentTimeMillis();
//        FileInputStream fis = new FileInputStream(path);
//        int code = gifDecoder.read(fis);
//        if (code == GifDecoder.STATUS_OK) {//解码成功
//            gifFrames = gifDecoder.getFrames();
//        }
//        //LogUtils.e("loadGifSource",System.currentTimeMillis() - timeStart+"");
//    } catch (
//    FileNotFoundException e) {
//        e.printStackTrace();
//    }
//    GifDecoder.GifFrame[] finalGifFrames = gifFrames;
