...
//        else if (radius < 630000) result = 2;
    ...
    public static void main(String[] args) {
        ...
        //判断当前地图是否移动，移动了则要 请求服务器做相应的业务操作
//        GeoHash g = new GeoHash(centerPoint.latitude, centerPoint.longitude);
//      //int bits= effectnum(radius);
//        int bits = 5;//大概两公里，这次移动和上次移动的在两公里范围内不会重新请求
//        g.sethashLength(bits);
//        String geoCode = g.getGeoHashBase32();
//        if (!geoCode.equals(currentGeoCode)) {
//
